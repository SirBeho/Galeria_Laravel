      ...
      <nav className=" text-white bg-nav fixed top-0 w-full z-20 p-2">
        <div className="flex justify-between items-center   min-[900px]:px-52 h-10">
          ...
          <div className="h-full flex items-center  ">
            <div className="h-full flex gap-3 items-center cursor-pointer hover:scale-105 ps-4 rounded-md">
              <img src="favico.png" className="h-full w-auto" alt="" />
              <a className="text-white text-xl w-fit " href="./">Mundo del Cumpleaños</a>
            </div>
            
            <button onClick={AltVerJuegos}
             className="ms-2 md:ms-8 text-white font-bold rounded-lg hover:scale-110 hover:cursor-pointer hover:text-blue-500 hover:fill-blue-500">
        ...
        <div className="flex gap-3">
            ...
            <div className="w-5 self-center"> 
              {/*estadoVisual 0 = grande 1= mediano 2= pequeño*/}
              {estadoVisual == 0 ? (
                <img src="tres.svg" alt="grande" className="cursor-pointer hover:scale-110" onClick={AltGrande} />
              ) : estadoVisual == 1 ? (
                <img src="dos.svg" alt="mediano" className="cursor-pointer hover:scale-110" onClick={AltGrande} />
              ) : (
                <img src="uno.svg" alt="pequeño" className="cursor-pointer hover:scale-110" onClick={AltGrande} />
              )}
            </div>
        </div>

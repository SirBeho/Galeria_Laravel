...
export function DataTable({ data, action, tbStructure, onNew, onUpdate, onDelete, proteccionUser = 0 }) {
    ...
    // 1 const [filtro, setFiltro] = useState(null);
    ...
    //dos, porque elk uno no esta hecho
    ...
    useEffect(() => {
        console.log('objective data changed',data)
    ...
    useEffect(() => {
        console.log('filteredData or page changed')
        ...
        <>
            <div className="my-2 flex min-[400px]:flex-row flex-col gap-4 items-center">
                ...
                <label className="flex items-center gap-4 h-10 bg-white text-gray-500 leading-tight  rounded-lg  overflow-hidden p-4">
                        <select value={filtro} onChange={(e) => setFiltro(parseInt(e.target.value))} className=" border-0 hover:bg-gray-100 hover:text-gray-700 " >
            ...
            <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 pt-4 overflow-x-auto">
                ...
                <div className='flex justify-between py-4'>
                    ...
                    <label className="flex items-center gap-4 h-10 bg-white text-gray-500 leading-tight  rounded-lg  overflow-hidden p-4">
                        <span>Filas</span>
                        <select value={itemsPerPage} onChange={(e) => setItemsPerPage(parseInt(e.target.value))} className=" border-0 hover:bg-gray-100 hover:text-gray-700 " >

    ...
    <Layout carrito={carrito} user={user} setNewCarrito={setNewCarrito} eliminar={showEliminar}  mostrar={() => setShowEliminar(!showEliminar)} >
      ...
      <div>
        ...
        <Modal show={openProdutM}  close_x={true} header={"Detalle del Artículo"} onClose={() => { setOpenProdutM(false) }} 
              galeria ={<>
                <button onClick={goToPreviousImage}    className="sticky left-0 top-1/2 ms-2 z-50 text-white p-1 rounded-full hover:bg-blue-700 cursor-pointer">
                ...
                <button onClick={goToNextImage}     className="sticky left-full top-1/2 me-2 z-50  text-white p-1 rounded-full hover:bg-blue-700 cursor-pointer ">
